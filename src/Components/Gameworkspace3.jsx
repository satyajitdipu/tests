...
const Gameworkspace = () => {
  ...
  return (
    <>
      <section className="mt-xl-5 mt-lg-4 mt-md-3 mt-3 py-xl-5 py-lg-4 py-md-3 py-3 orange_bg_pt">
        <div className="container py-xl-5 py-lg-5 py-md-4 py-2">
          <div className="row">
            <div className="col-xl-6 col-lg-6 col-md-12 col-12">
              ...
              Psychologists <br /> or Behavioral Therapists
              </h1>
            ...
            <div className="col-xl-6 col-lg-6 col-md-12 col-12 text-end">
              <img src={card_img3} className="img-fluid w-75" alt="card_img1" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container ">
          ...
          <div className="row">
            <h4 className="fw-bold py-xl-4 py-lg-4 py-md-3 py-2">
              A Few of Our Speech Therapy Games
            </h4>
            <div className="row">
              <div
                onClick={handleClick}
             ...
             <div className="container sky_bg">
              <div className="row">
                ...
                <div className="col-xl-6 col-lg-6 col-md-6 col-12 py-xl-5 py-lg-4 py-md-3 py-3">
                       <h2 className="fw-bold text-light my-xl-4 my-lg-4 my-md-3 my-3">Psychologists or Behavioral Therapy Hub</h2>
